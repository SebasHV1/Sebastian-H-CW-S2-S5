                        ...
                        <div class='zona-pregunta'>
                            ...
                            <div id='contenedorPreguntas' style='display: none;'>
                                ...
                                if($querypreguntas){
                                    ...
                                    echo" <div class='anuncio' id='anuncio3'>#$ID_Pregunta
                                        <br> ¡Nueva pregunta! 
                                        <br> ¿$Preguntaaaa?
                                        <br> Realizada por
                                    ";
                                    ...
                                    <div class='respuesta' id='$ID_Pregunta'>Hola, soy una pregunta</div>
                                    <div id='responder' name='responder' class='responder'>
                                        <form id='responderpreguntas$ID_Pregunta'>
                                            ...
                                            <button id='cancelar-respuesta'>Cancelar</button>
                                            </form>
                                        </div>"; 
                                     }
                                }echo"
                            
                            <div class='respuesta'>Hola yo soy una respuesta</div>
                            <div class='respuesta'>Hola yo soy otra respuesta</div>
                        </div>
                        </div>
